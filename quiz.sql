...
INSERT INTO `pregunta` VALUES (1,'Â¿tomalo...?','que no lo quiero',3,'ima000@ikasle.ehu.es'),(2,'Â¿funka?','pues claro',2,'jgonzalez001@ikasle.ehu.es'),(3,'Ã‚Â¿pim, pam, ...?','pum',3,'ima000@ikasle.ehu.es');
